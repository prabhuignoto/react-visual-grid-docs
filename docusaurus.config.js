...
const config = {
  ...
  organizationName: 'prabhuignoto', // Usually your GitHub org/user name.
  projectName: 'react-visual-grid', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/prabhuignoto/react-visual-grid-docs/tree/main/',
        },
        blog: {
